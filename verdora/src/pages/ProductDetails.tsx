      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: isMobile ? "16px" : "20px", marginBottom: "32px" }}>
              <div style={{ backgroundColor: "#f9f9f9", padding: isMobile ? "16px" : "20px", borderRadius: "4px", textAlign: "center" }}>
                <div style={{ fontSize: isMobile ? "11px" : "12px", color: "#999", marginBottom: "8px", textTransform: "uppercase" }}>☀️ Sunlight</div>
                <div style={{ fontSize: isMobile ? "13px" : "14px", fontWeight: "600", color: "#333" }}>{product.sunlight || "N/A"}</div>
              </div>
              <div style={{ backgroundColor: "#f9f9f9", padding: isMobile ? "16px" : "20px", borderRadius: "4px", textAlign: "center" }}>
                <div style={{ fontSize: isMobile ? "11px" : "12px", color: "#999", marginBottom: "8px", textTransform: "uppercase" }}>💧 Water</div>
        ...
        <div style={{ marginTop: isMobile ? "60px" : "80px", paddingTop: isMobile ? "40px" : "60px", borderTop: "1px solid #e0e0e0" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit, minmax(280px, 1fr))", gap: isMobile ? "32px" : "40px" }}>
            <div>
              <h4 style={{ fontSize: isMobile ? "12px" : "14px", fontWeight: "700", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "16px", color: "#333" }}>💧 Watering & Light</h4>
            ...
            <div>
              <h4 style={{ fontSize: isMobile ? "12px" : "14px", fontWeight: "700", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "16px", color: "#333" }}>🌱 Growth & Characteristics</h4>
              <ul style={{ listStyle: "none", padding: "0", margin: "0", fontSize: isMobile ? "13px" : "14px", lineHeight: "1.8", color: "#666" }}>
            ...
            <div>
              <h4 style={{ fontSize: isMobile ? "12px" : "14px", fontWeight: "700", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "16px", color: "#333" }}>🌍 Environment & Soil</h4>
              <ul style={{ listStyle: "none", padding: "0", margin: "0", fontSize: isMobile ? "13px" : "14px", lineHeight: "1.8", color: "#666" }}>
          ...
          {product.careTips && (
            <div style={{ backgroundColor: "#f9f9f9", padding: isMobile ? "16px" : "24px", borderRadius: "4px", marginTop: "32px", borderLeft: "3px solid #333" }}>
              <h5 style={{ fontSize: isMobile ? "12px" : "13px", fontWeight: "700", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "12px", color: "#333" }}>💡 Pro Care Tips</h5>
